...
(RegCartClient.prototype.identifyByConfirm as $TSFixMe).mockImplementation(() => Promise.resolve({}));
...
test('logged in from /cancelRegistration then route to Post Reg page', async () => {
  let mainApp;
  await act(async () => {
