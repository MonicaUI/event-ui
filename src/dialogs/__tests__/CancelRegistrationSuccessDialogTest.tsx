...
import { openCancelRegistrationSuccessConfirmationDialog } from '../CancelRegistrationSuccessDialog';
...
describe('CancelRegistrationSuccessConfirmationDialog', () => {
  const dialog = mount(
  ...
  test('matches snapshot when opened', () => {
    store.dispatch(openCancelRegistrationSuccessConfirmationDialog());
