...
import { openSessionOverlapWarningDialog } from '../SessionOverlapWarningDialog';
...
describe('SessionOverlapWarningDialog', () => {
  const dialog = mount(
  ...
  test('matches snapshot when opened', () => {
    store.dispatch(openSessionOverlapWarningDialog());
