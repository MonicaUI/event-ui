...
export const openInformationAlreadyUsedDialog = () => {
  return (dispatch: $TSFixMe, getState: $TSFixMe): $TSFixMe => {
    ...
    const dialog = (
      <Dialog
        ...
        message={translate('EventGuestSide_InformationAlreadyUsed_Error_Message__resx')}
        subMessage={translate('EventGuestSide_InformationAlreadyUsed_Error_SubMessage__resx')}
        title={translate('EventGuestSide_InformationAlreadyUsed_Error_Message__resx')}
        icon="error"
        iconModifier="error"
